...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className="mt-1 text-navy/60">Tu espacio seguro para crecer. Cada paso cuenta.</p>
      ...
      <div className="mt-8 rounded-card-lg bg-[linear-gradient(135deg,var(--color-gradient-from),var(--color-gradient-to))] p-8 text-white">
        <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest opacity-80">
          <Sparkles size={14} /> Para ti hoy
        </p>
        <h2 className="mt-3 text-xl font-semibold">No estás solo/a en esto 💜</h2>
      ...
      <h3 className="mt-10 text-lg font-semibold">Explora</h3>
          ...
          const content = (
            <>
              <div className="flex items-start justify-between">
                ...
                <span className="rounded-pill bg-navy/5 px-2.5 py-1 text-[11px] font-semibold text-navy/60">
                  {card.badge}
                </span>
              </div>
